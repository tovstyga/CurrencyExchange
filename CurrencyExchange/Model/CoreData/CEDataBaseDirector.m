...
@implementation CEDataBaseDirector

static CEDataBaseDirector *instanceDataBaseDirector;

+(CEDataBaseDirector *)instance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instanceDataBaseDirector = [[CEDataBaseDirector alloc] init];
